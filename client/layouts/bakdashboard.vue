            ...
            <div class="sidebar__region">
              <div class="card current-site">
                ...
                <div class="all-sites"><a class="site__content"><span class="count">4</span>
                  <div class="site__info"><span class="site__title">所有应用</span><!-- react-text: 104 -->
                    <!-- /react-text -->
                    <div class="all-sites-icon" :class="`has-${org.apps.length}-icons`">
                      <div class="site-icon is-blank"
                           style="height: 14px; width: 14px; line-height: 14px; font-size: 14px;"
                           v-for="app in org.apps">
                        <img :src="app.meta.basic.logo_url" v-if="app.meta.basic.logo_url" :title="app.meta.basic.name">
                        <svg class="gridicon gridicons-globe" height="11" width="11"
                             xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24" v-else>
                          <g>
              ...
              <div>
                <li class="sidebar__menu">
                  ...
                  <ul>
                    ...
                    <li class="" data-post-type="media"><a href="/media/bluepx.wordpress.com">
                      <icon name="tasks" class="gridicon"></icon>
                      <span class="menu-link-text">任务</span></a>
                ...
                <li class="sidebar__menu">
                  ...
                  <ul>
                    ...
                    <li class="">
                      <a href="/comments">
                        <icon name="user" class="gridicon"></icon>
                        <span class="menu-link-text">账户</span></a>
                    </li>
