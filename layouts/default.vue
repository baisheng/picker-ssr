                  ...
                  <div>
                    <div class="site"><a class="site__content" title="选择站点 bluepx.wordpress.com"
                      ...
                      <div class="site__info">
                        <!-- TODO: 加载每次请求中 -->
                        <!--<div class="site__title">{{ org.basic.name }}</div>-->
                        <!--<div class="site__domain">{{ org.subdomain }}</div>-->
                      </div>
                    </a>
                    ...
                    <ul>
                      ...
                      <li class="">
                        <a href="/posts/my">
                          ...
                          <span class="menu-link-text">专辑</span>
                        </a>
                  ...
                  <li class="sidebar__menu"><h2 class="sidebar__heading">配置</h2>
                    <ul>
                      ...
                      <li class="settings" data-tip-target="settings">
                        ...
                        <span class="menu-link-text">设置</span></a></li>
                    </ul>
                  </li>
                </div>
              </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      org () {
        return this.$store.state.org.orgInfo.data
      }
    }
  }
</script>
